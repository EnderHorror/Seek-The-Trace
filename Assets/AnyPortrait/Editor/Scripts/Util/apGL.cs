...
namespace AnyPortrait
{
	...
	public static class apGL
	{
			...
			int posX, int posY, int totalEditorWidth, int totalEditorHeight)
		{
			...
			_animRatio_BoneOutlineAlpha = (0.3f * (1.0f - outlineLerp)) + (1.0f * outlineLerp);//최소 Alpha는 0이 아닌 0.5
		...
		public static void DrawSelectedBone_V1(apBone bone, bool isMainSelect = true, bool isBoneIKUsing = false)
		{
			if (bone == null)
			{
				return;
		...
		public static void DrawSelectedBone_V2(apBone bone, bool isMainSelect = true, bool isBoneIKUsing = false)
		{
			//본 그리기 + 두꺼운 외곽선
